  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Apply and track your leave requests</Text>
      </View>
      ...
      <View style={styles.fallbackCard}>
        ...
        <Text style={styles.fallbackMessage}>
          Please install react-native-webview to enable the Leave Management portal.
        </Text>
        <View style={styles.instructionBox}>
          ...
          <Text style={styles.instructionNote}>Then rebuild the app.</Text>
        </View>
      </View>
    </View>
  );
