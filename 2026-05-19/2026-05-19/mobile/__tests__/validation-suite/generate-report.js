...
<title>Farmley SFA v2 - Full Mobile App Validation Report</title>
<style>
...
<h1>Farmley SFA v2 — Full Mobile App Validation Report</h1>
<p>Generated: ${now} | Framework: Jest (Node.js) | Duration: ${duration}s</p>
</div>`;
...
<div class="summary-card"><div class="num">${passedSuites}/${totalSuites}</div><div class="label">Suites Passed</div></div>
  ...
  html += `<div class="footer">Farmley SFA v2 Mobile App — Full Mobile App Validation Test Suite | Jest Framework</div>`;
  html += `</body></html>`;

  const outPath = __dirname + '/report/Validation_Test_Report.html';
